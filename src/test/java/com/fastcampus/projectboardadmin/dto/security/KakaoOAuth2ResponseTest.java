...
@DisplayName("DTO - Kakao OAuth 2 인증 응답 데이터 테스트")
class KakaoOAuth2ResponseTest {

    private final ObjectMapper mapper = new ObjectMapper();

    @DisplayName("인증 결과를 Map(desserialized json)으로 받으면, 카카오 인증 응답 객체로 변환한다")
    @Test
    void givenMapFromJson_whenInstantiating_thenReturnsKakaoResponseeObject() throws JsonProcessingException {
        // Given
