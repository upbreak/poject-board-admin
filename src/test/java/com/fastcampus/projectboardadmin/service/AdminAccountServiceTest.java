...
class AdminAccountServiceTest {
    ...
    @Test
    void givenUserId_whenSearch_thenReturnOptionalUserData() {
        // Given
    ...
    @Test
    void givenNonUserId_whenSearch_thenReturnOptionalUserData() {
        // Given
    ...
    @Test
    void givenUserParams_whenSave_thenSaveAdminAccount() {
        // Given
        AdminAccount adminAccount = createSigningUpAdminAccount("jinwoo", Set.of(RoleType.USER));
    ...
    @Test
    void givenNothing_whenSelectAdmin_thenReturnAllAdmin() {
        // Given
    ...
    @Test
    void givenUserId_whenDeleteAdmin_thenDeleteAdmin() {
        // Given
